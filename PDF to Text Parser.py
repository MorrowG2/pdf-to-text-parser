...
import time
# If nltk is not downloaded remove the hashtag below to download it
# nltk.download()

# Change the txt file below to whatever you want the PDF changed to one
# the data is parsed
resume_file = open("Resume.txt", "w", encoding="utf-8") 

# write a for-loop to open many files
# like to learn how
# for a in filename ... look up the rest for loop

# Enter file name after filename = ''
filename = 'Upwork.Rigging.Inventory-20191024.pdf'
...
# Remember python always begins at 0. 0 is 1 and 1 is 2 and so on
count = 0
text = ""
